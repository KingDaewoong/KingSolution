...
# 아래 한계값은 1020이 마지노선 
        ...
        elif 800 > Supreme_sell > 600 and My_ripple >= 186.0:
...
#         elif 300 > Supreme_sell > 200 and My_ripple >= 92.0:
#             print(upbit.sell_limit_order("KRW-XRP", int(orderbook['bid_price'])+2, 94))
#             print(My_ripple)
#             print(My_KRW)

#         elif 300 > Supreme_sell > 200 and My_KRW >= 18800.0:
#             print(upbit.buy_limit_order("KRW-XRP", int(orderbook['ask_price'])-2, 94))
#             print(My_ripple)
#             print(My_KRW)
# # 각 호가는 2의 배수
